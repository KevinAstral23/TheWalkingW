...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    await query.message.edit_text("𝖡𝖴𝖣𝖣𝖸, 𝖬𝖺𝗄𝖾 𝖲𝗎𝗋𝖾 𝖨'𝗆 𝖨𝗇 𝖸𝗈𝗎𝗋 𝖦𝗋𝗈𝗎𝗉", quote=True)
                    return await query.answer('𝖲𝖧𝖠𝖱𝖤 &𝖲𝖴𝖯𝖯𝖮𝖱𝖳')
            else:
        ...
        if (st.status == enums.ChatMemberStatus.OWNER) or (str(userid) in ADMINS):
            ...
            await query.answer("𝖸𝖮𝖴 𝖧𝖠𝖵𝖤 𝖳𝖮 𝖡𝖤 𝖮𝖶𝖭𝖤𝖱!", show_alert=True)
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if (st.status == enums.ChatMemberStatus.OWNER) or (str(userid) in ADMINS):
                ...
                await query.answer("𝖤𝖸𝖸, 𝖳𝗁𝖺𝗍'𝗌 𝖭𝗈𝗍 𝖥𝗈𝗋 𝖸𝗈𝗎 𝖡𝖴𝖣𝖣𝖸!", show_alert=True)
...
𝖧𝖾𝗋𝖾 𝗂𝗌 𝗆𝗒 𝖧𝖤𝖫𝖯 𝖢𝗈𝗆𝗆𝖺𝗇𝖽𝗌
        ...
        buttons = [[
            InlineKeyboardButton("➕️ 𝖠𝖣𝖣 𝖬𝖤 𝖳𝖮 𝖴𝖱 𝖦𝖱𝖮𝖴𝖯 ➕️", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
            InlineKeyboardButton("🔍 𝖨𝗇 𝖫𝗂𝗇𝖾 𝖲𝖾𝖺𝗋𝖼𝗁🔍", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("📢 𝖡𝖮𝖳 𝖴𝗉𝖽𝖺𝗍𝖾𝗌 📢", url="https://t.me/k_ASTRA1")
            ],[
            InlineKeyboardButton("𝖤𝖭𝖰𝖴𝖨𝖱𝖤𝖲 💭", url="https://t.me/k_ASTRA1")
            InlineKeyboardButton("𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 📜", url="https://t.me/Movie_GenieSUPPORT")
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝖯𝖴𝖱𝖦𝖤', callback_data='purges')
            ],[
            InlineKeyboardButton('𝖯𝖠𝖲𝖳𝖤', callback_data='pastes'),
            InlineKeyboardButton("𝖨𝗆𝖺𝗀𝖾", callback_data='image'),
            InlineKeyboardButton('𝖯𝖨𝖭𝖦', callback_data='pings')                                   
            ],[                               
            InlineKeyboardButton('𝖬𝖴𝖳𝖤', callback_data='restric'),
            ...
            InlineKeyboardButton('𝖸𝖳 𝖣𝖫', callback_data='ytdl')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('𝖬𝗈𝗋𝖾 𝖨𝖭𝖥𝖮', callback_data='source')
            ],[
